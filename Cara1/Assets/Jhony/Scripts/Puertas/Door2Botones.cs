...
public class Door2Botones : Door
{
    [SerializeField]
    ...
    {
        if (BotonNecesario1.gameObject.GetComponent<Button>().Presionado == true && BotonNecesario2.gameObject.GetComponent<Button>().Presionado == true)
        {
